...
1. Clonar el repositorio: `git clone https://github.com/tu-usuario/proyecto-videojuegos-ice.git`
2. Instalar dependencias: `pip install -r requirements.txt`
3. Ejecutar el notebook: `jupyter notebook videogames_analysis.ipynb`

---

**Desarrollado por [Tu Nombre]** - _Data Analyst_
